...
import springbootstudy.shiro.config.ShiroConfiguration;

/**
 * @author Jul.18th.M
 * @date 2019-01-25 14:07
 * description 登陆控制器
 */
@RestController
public class LoginController {
    ...
    public String login(String username, String password, RedirectAttributes model){
        ...
        // 认证执行者交由 springbootstudy.shiro.config.AuthRealm 中 doGetAuthenticationInfo 处理
